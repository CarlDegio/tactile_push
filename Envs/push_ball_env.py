...
class PushBallEnv0(gym.Env):
    ...
    def __init__(self, render_mode=None, seed=None, dense_reward=False, tactile=True):
        ...
        self.real_ball_pos = np.array([0.32, 0.0, 0.03])
    ...
    def _get_obs(self):
        ...
        self.real_ball_pos = get_state.get_ball_pos(self.sphere)
        ...
        obs = {
            ...
            "ball_x": self.real_ball_pos[0],
            "ball_y": self.real_ball_pos[1],
    ...
    def reset(self, seed=None, options=None):
        ...
        self.real_ball_pos = np.array([0.32, start_y, 0.03])
        reset.reset_ball_pos(self.sphere, self.real_ball_pos)
